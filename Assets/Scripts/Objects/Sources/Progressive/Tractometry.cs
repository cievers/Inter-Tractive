		...
		public override IEnumerable<Interface.Component> Controls() {
			return new Interface.Component[] {
				...
				new Folder.Data("Global measuring", new List<Controller> {
					...
					new ActionToggle.Data("Mean span", false, spanMesh.gameObject.SetActive),
					new ActionToggle.Data("Cross-section", false, cutMesh.gameObject.SetActive),
					...
					new ActionToggle.Data("Volume", false, volumeMesh.gameObject.SetActive),
